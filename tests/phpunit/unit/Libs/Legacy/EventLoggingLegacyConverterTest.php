...
/**
 * @covers \MediaWiki\Extension\EventLogging\Libs\Legacy\EventLoggingLegacyConverter
 */
class EventLoggingLegacyConverterTest extends TestCase {
	...
	public function testFromHttpRequest() {
		...
		$_server = [
			'QUERY_STRING' => '?%7B%22schema%22%3A%22MediaWikiPingback%22%2C%22revision%22%3A15781718%2C' .
	...
	public function testFromHttpRequestBadEncoding() {
		$_server = [
			'QUERY_STRING' => '?%%22schema%22%3A%22MediaWikiPingback%22%2C%22revision%22%3A15781718%2C%22wiki%22' .
				'%3A%22dummy%22%2C%22event%22%3A%7B%22database%22%3A%22mysql%22%2C%22MediaWiki%22' .
				'%3A%221.31.1%22%2C%22PHP%22%3A%227.4.33%22%2C%22OS%22%3A%22Linux%5Cu00204.4.400-icpu-097%22%2C%22' .
				'arch%22%3A64%2C%22machine%22%3A%22x86_64%22%2C%22serverSoftware%22%3A%22Apache%22%7D%7D;',
			'REMOTE_HOST' => self::RECV_FROM,
			'HTTP_USER_AGENT' => self::USER_AGENT
		];
	...
	public function testDecodeQson() {
		$input = '?%7B%22schema%22%3A%22MediaWikiPingback%22%2C%22revision%22%3A15781718%2C%' .
